...
<tr>
    ...
    <input type="text" list="visitor_mobile_no" autofocus placeholder="01700000000" name="visitor_mobile_no" id="mobile_no" />
 ...
 <?php } ?>    
  ...
  <tr>
    ...
    <th scope="col">
    <span id="visitor_address"><input name="visitor_address" type="text" required /></span>
