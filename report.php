...
<div class="row-fluid">
    <div class="block">
        ...
        <form action="report_date_date1.php" method="post" target="_blank">
				<table border="1" width="90%" cellpadding="0" align="center" cellspacing="0">
				<tr>
				  <th class="blue-left">From Date</th>
				  <th class="blue-left">To Date</th>
				  <th class="blue-left">Visitor Type</th>
				  <th class="blue-left">Contact Number</th>
				  </tr>
				<tr>
				  <td class="blue-left"><input name="date1" id="date1" type="text" tabindex="1" onClick="showCalendarControl(this);" required autofocus></td>
				  <td class="blue-left"><input name="date2" type="text" id="date2" onClick="showCalendarControl(this);" tabindex="2" required ></td>
				  <td class="blue-left"><select name="card_type" class="country" id="card_type">
                    <option value="" selected>--Select Type--</option>
                    <?php
                    $SQL="select card_type from tb_visitor_card group by card_type ";
                            $obj->sql($SQL);
                  ...
                  <td class="blue-left"><input type="text" list="visitor_mobile_no"  name="visitor_mobile_no" id="visitor_mobile_no" >
                  ...
                  <input type="submit" class="btn btn-info" name="submit" id="submit" value="Submit" tabindex="3" />
                  <input type="reset" class="btn btn-danger" name="reset" id="reset" value="Reset" tabindex="3" />
                  </div>
     </form>
