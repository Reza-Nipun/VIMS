<?php
	...
	$visitor_type=mysql_real_escape_string($_POST['visitor_type']);
...
<tr>
    <th scope="col" style="color:#000" align="left" id="td_contact_no">Visitor's contact no. :</th>
    <th scope="col">
    <!--<input type="text" list="visitor_mobile_no" autofocus placeholder="01700000000" name="visitor_mobile_no" onblur=stdCode(this.value,1,0)  />-->
    
    <input type="text" list="visitor_mobile_no" tabindex="1" autofocus placeholder="01700000000" name="visitor_mobile_no" id="mobile_no" />
 ...
 {   
 ?>
 <option value="<?php echo $row['visitor_mobile_no']; ?>"><?php echo $row['visitor_mobile_no'] ?></option>
 <?php }
 
 
 
 $SQL="select visitor_nick_name, visitor_company_name from tb_visitor_info group by visitor_nick_name order by visitor_nick_name ASC"; 
 $results = $obj->sql($SQL);
 while($row = mysql_fetch_array($results))
 {
 ?>
 <option value="<?php echo $row['visitor_nick_name'].'~'.$row['visitor_company_name']; ?>"><?php echo $row['visitor_nick_name'].'~'.$row['visitor_company_name']; ?></option>
 <?php } ?>  
  ...
  <tr>
    ...
    <!--<th scope="col">
    <span id="visitor_name"><input name="visitor_name" type="text" required/></span>
    &nbsp;<img src="images/icon_required_field.gif">
    </th>-->
   
    <th scope="col">
    <span id="visitor_name"><input name="visitor_name" value="" tabindex="2" type="text" required/></span>
    &nbsp;<img src="images/icon_required_field.gif"></th>
    
  </tr>
  
  
  
  <tr id="td_iv_mobile_no" style="display:none">
    <th scope="col" style="color:#000" align="left">Visitor's Mobile No :</th>
    <th scope="col">
    <span id="iv_mobile_no"><input name="iv_mobile_no" id="input_iv_mobile_no" tabindex="3" type="number" maxlength="11" required /></span>
    &nbsp;<img src="images/icon_required_field.gif"></th>
  </tr>
  
  <tr>
    <th scope="col" style="color:#000" align="left">Visitor's Company Name :</th>
    <th scope="col">
    <span id="visitor_company_name"><input name="visitor_company_name" tabindex="3" type="text" required /></span>
    &nbsp;<img src="images/icon_required_field.gif"></th>
  </tr>
  
  <tr id="td_visitor_address">
    <th scope="col" style="color:#000" align="left">Visitor's Address :</th>
    <th scope="col">
    <span id="visitor_address"><input name="visitor_address" id="input_visitor_address" tabindex="4" type="text" required /></span>
    &nbsp;<img src="images/icon_required_field.gif"></th>
  </tr>
  ...
  <tr>
   ...
   <th width="60%" scope="col">
    <select name="visiting_card_no" id="visiting_card_no" tabindex="5" required>
   ...
   <?php // if($visitor_type!='Other') { ?>
	...
	{ 
		//$SQL="SELECT card_no FROM vt_visitor_card";
  ...
  <tr>
   ...
   <tr>
    <th scope="col" style="color:#000" align="left">Reason of Visit :</th>
    <td align="center"><textarea name="visit_reason" tabindex="7" cols="35" rows="3" id="visit_reason" required ></textarea>
    &nbsp;<img src="images/icon_required_field.gif"></td>
    
    <!--<th scope="col">
    <span id="visitor_name"><input name="visit_reason" type="text" required/></span>
    &nbsp;<img src="images/icon_required_field.gif">
    </th>-->
  </tr>
  ...
  <tr>
    ...
    <th width="60%" scope="col"><input name="contact_person" type="text" tabindex="8" id="contact_person"  />&nbsp;&nbsp;&nbsp;&nbsp;</th>
  </tr>
  <!--<tr>
    <th width="40%" style="color:#000" scope="col" align="left">Contact Person's Dept. :</th>
    <th width="60%" scope="col"><input name="contact_person_dept" tabindex="9" type="text" id="contact_person_dept"  />&nbsp;&nbsp;&nbsp;&nbsp;</th>
  </tr>-->
  <tr>
    <th width="40%" style="color:#000" scope="col" align="left"> Date :</th>
    <th width="60%" scope="col"><input name="date" type="text" tabindex="10" value="<?php echo $date; ?>" placeholder="mm-dd-yyyy" onclick="showCalendarControl(this);" required  />&nbsp;<img src="images/icon_required_field.gif"></th>
  </tr>
  
  <tr>
    <th width="40%" style="color:#000" scope="col" align="left"> Visitor In Time :</th>
    <th width="60%" scope="col"><input name="visitor_in_time" id="visitor_in_time" type="text"  value="<?php echo $datex; ?>" tabindex="11" required readonly />&nbsp;<img src="images/icon_required_field.gif"></th>
  </tr>
  
   <tr>
    <th scope="row" style="color:#000" align="left">Remarks</th>
    <td align="center"><textarea name="remarks" cols="35" rows="3" tabindex="12" id="remarks"></textarea>&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
 ...
 <input type="hidden" name="visitor_type" value="<?php echo $visitor_type ; ?>" id="hiddenField"/></th>
    ...
    <th width="60%" scope="col">
    <INPUT name="Submit" type="submit" class="btn btn-primary" value="Submit" tabindex="14" />
    <INPUT name="Reset" type="reset" class="btn btn-primary"  value="Reset" tabindex="15" />
    </th>
  </tr>
