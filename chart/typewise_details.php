...
<hr />
<span style="font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif; font-size:20px">Visitor Type Wise Report</span>
<hr />
...
<table width="1300px" border="0" cellspacing="0" cellpadding="0" class="bottomBorder">
  <tr bgcolor="#BFBFBF">
   ...
   <?php
	...
	$SQL1="SELECT * FROM tb_visitor_info WHERE sub_type='$sub_type'"; 
...
<!--<table width="98%" border="0" cellspacing="0" cellpadding="0" class="bottomBorder">
  <tr bgcolor="#BFBFBF">
   ...
   <?php
    /*$SQL1="SELECT * FROM tb_visitor_info WHERE sub_type='$sub_type'";    //table name
	$results1 = $obj->sql($SQL1);
	$sl=1;
	while($row = mysql_fetch_array($results1))
	{
