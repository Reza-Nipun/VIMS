...
<div class="row-fluid">
    <div class="block">
        ...
        <form action="report_date_date1.php" method="post" target="_blank">
				...
				<tr>
				  <td class="blue-left"><span style="color:#000">&nbsp;From :&nbsp;</span>
                  <input name="date1" id="date1" type="text" tabindex="1" onClick="showCalendarControl(this);" required autofocus>
                  &nbsp;To :&nbsp;<input name="date2" type="text" id="date2" onClick="showCalendarControl(this);" tabindex="2" required >
    ...
    <div class="block">
        <!--<p class="block-heading" data-toggle="collapse" >Select visitor type</p>-->
         <div class="block-heading" data-toggle="collapse" data-target="#tablewidget">
           <h4 style="color:#09F">Report Contact No. Wise</h4>
         </div>
        <br>
        ...
        <form action="report_date_date1.php" method="post" target="_blank">
				<table border="1" width="90%" cellpadding="0" align="center" cellspacing="0">
				<tr>
				  <td class="blue-left"><span style="color:#000">&nbsp;Contact No :&nbsp;</span>
                  <input type="text" list="visitor_mobile_no"  name="visitor_mobile_no" id="visitor_mobile_no" >
    ...
    <div class="block">
        <!--<p class="block-heading" data-toggle="collapse" >Select visitor type</p>-->
         <div class="block-heading" data-toggle="collapse" data-target="#tablewidget">
           <h4 style="color:#09F">Report Type Wise</h4>
         </div>
        <br>
...
$(".city").html(html);
        ...
        <form action="report_date_date1.php" method="post" target="_blank">
				<table border="1" width="90%" cellpadding="0" align="center" cellspacing="0">
				<tr>
				  <td class="blue-left"><span style="color:#000">&nbsp;Type :&nbsp;</span>
                  <!--<input type="text" name="visitor_mobile_no" id="visitor_mobile_no" >-->
                  
               <select name="sub_type" class="country" id="sub_type">
<option value="" selected>--Select Type--</option>
<?php
$SQL="select * from tb_visitor_info group by sub_type ";
		$obj->sql($SQL);
...
<!--<select name="type" class="country" id="type">
<option value="" selected>--Select Type--</option>
<?php
//$SQL="select * from tb_sub_type group by type ";
		//$obj->sql($SQL);
		//while($row = mysql_fetch_array($obj->result))
//{ 
//$dis=$row['type'];
...
-->
                 <!-- &nbsp;sub-type :&nbsp;-->
        <!--  <select name="problem" class="city" id="problem">
